...
@Component({
  selector: 'app-infomaestrias',
  templateUrl: './infomaestrias.component.html',
  styleUrls: ['./infomaestrias.component.css']
})
export class InfomaestriasComponent implements OnInit {
