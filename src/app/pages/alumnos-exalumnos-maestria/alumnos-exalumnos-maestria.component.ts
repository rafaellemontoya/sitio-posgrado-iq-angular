...
@Component({
  selector: 'app-alumnos-exalumnos',
  templateUrl: './alumnos-exalumnos-maestria.component.html',
  styleUrls: ['./alumnos-exalumnos-maestria.component.css']
})
export class AlumnosExalumnosMaestriaComponent implements OnInit {
...
getInfo() {
  this.http.get('https://www.themyt.com/UAMI/get_plan_estudios_maestria.php').subscribe((data: any)=>{
    console.log(data);
