...
@Component({
  selector: 'app-articulos-de-investigacion',
  templateUrl: './articulos-de-investigacion.component.html',
  styleUrls: ['./articulos-de-investigacion.component.css']
})
export class ArticulosDeInvestigacionComponent implements OnInit {
...
getInfo() {
  this.http.get('https://www.themyt.com/UAMI/get_articulos_de_investigacion.php').subscribe((data: any)=>{
    console.log(data);
