...
@Component({
  selector: 'app-proyectos-investigacion-maestria',
  templateUrl: './proyectos-investigacion-maestria.component.html',
  styleUrls: ['./proyectos-investigacion-maestria.component.css']
})
export class ProyectosInvestigacionMaestriaComponent implements OnInit {
  tituloPagina='';
  subtituloPagina1='';
  subtituloPagina2='';
...
contenido6='';
  ...
  getInfo() {
    this.http.get('https://www.themyt.com/UAMI/get_proyectos_investigacion_maestria.php').subscribe((data: any)=>{
      console.log(data);
