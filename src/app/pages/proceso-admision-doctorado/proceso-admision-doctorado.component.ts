...
@Component({
  selector: 'app-proceso-admision-doctorado',
  templateUrl: './proceso-admision-doctorado.component.html',
  styleUrls: ['./proceso-admision-doctorado.component.css']
})
export class ProcesoAdmisionDoctoradoComponent implements OnInit {
...
getInfo() {
  this.http.get('https://www.themyt.com/UAMI/get_proceso_admision_doctorado.php').subscribe((data: any)=>{
    console.log(data);
