...
@Component({
  selector: 'app-plan-estudios-doctorado',
  templateUrl: './plan-estudios-doctorado.component.html',
  styleUrls: ['./plan-estudios-doctorado.component.css']
})
export class PlanEstudiosDoctoradoComponent implements OnInit {
...
getInfo() {
  this.http.get('https://www.themyt.com/UAMI/plan_estudios_doctorado.php').subscribe((data: any)=>{
    console.log(data);
